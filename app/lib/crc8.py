...
class CRC8:
    __crcTable = (0x00, 0x07, 0x0e, 0x09, 0x1c, 0x1b, 0x12, 0x15, 0x38,
    ...
    def calc(self, msg):
        ...
        for c in msg:
            c = ord(str(c))
            runningcrc = self.__crcbyte(runningcrc, c)
        return runningcrc

    def __crcbyte(self, oldcrc, byte):
        res = self.__crcTable[oldcrc & 0xFF ^ byte & 0xFF]
        return res
