...
rus = dict(logout='Выйти', home='Главная', sub='иерархия', spectras='Спектры', anon='Аноним', filters='фильтры',
